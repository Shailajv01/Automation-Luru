...
public class PipeLinePage extends BaseLuruAutomationPage {
	...
	public void editCompanyName(String updateName) {
		...
		// lstCompanyNames.get(i).sendKeys(Keys.CONTROL+"A");
		// lstCompanyNames.get(i).sendKeys(Keys.DELETE);
	...
	public void setEditLeadInputFields(String s) {
